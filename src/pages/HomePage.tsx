...
import { Shield, Zap, BookOpen, Users, Award, AlertTriangle, Play, Skull, RadioIcon as Radiation, Heart } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto space-y-12">
      ...
      <div className="text-center space-y-6">
        <div className="flex justify-center">
          <div className="p-4 bg-gradient-to-br from-red-100 to-orange-100 rounded-full border-2 border-red-300">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          es gab einen radioaktiven Unfall! Sammle <span className="text-green-600 font-semibold">Wissenspunkte</span>, 
          achte auf deine <span className="text-red-600 font-semibold">Strahlendosis</span> und überlebe in der Wasteland!
        </p>
      ...
      {/* Demo Section */}
      {!user && (
        <div className="bg-gradient-to-r from-red-600 via-orange-600 to-yellow-600 rounded-lg p-8 text-center text-white relative overflow-hidden">
