...
import { LogOut, User, Settings, Home, Gamepad2, RadioIcon as Radiation, Skull } from 'lucide-react';
                ...
                {user.role === 'student' && (
                  <div className="flex items-center space-x-4 text-sm">
                    <div className="flex items-center space-x-1 px-2 py-1 bg-green-600 rounded-full">
                      <span className="text-white font-semibold">🧠 {user.knowledge_points} WP</span>
                    </div>
