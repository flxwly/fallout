...
import { supabase, Level, Task, Option, Attempt, UserLevelProgress } from '../lib/supabase'
...
export function GameProvider({ children }: { children: React.ReactNode }) {
  ...
  const loadLevels = async () => {
    try {
      ...
      // Always use demo data for now since Supabase is not configured
      console.log('Loading demo levels...')
